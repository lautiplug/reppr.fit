          ...
          <div className="relative h-44 overflow-hidden">
            ...
            <div className="absolute bottom-0 left-0 right-0 px-4 pb-3 flex items-end justify-between">
              ...
              <div className="flex items-center gap-2 mb-0.5 shrink-0">
                ...
                <div className={`w-8 h-8 rounded-full flex items-center justify-center transition-colors ${expanded ? "bg-[#9BFF30]" : "bg-[#3A3A3C]"}`}>
              ...
              <div key={si} className="flex items-center gap-2">
                ...
                <button
                  ...
                  className={`w-10 h-11 shrink-0 rounded-xl flex items-center justify-center transition-colors ${
                    ...
                    : canComplete ? "bg-[#3A3A3C] text-[#8E8E93] hover:bg-[#9BFF30]/20 hover:text-[#9BFF30] transition-colors"
